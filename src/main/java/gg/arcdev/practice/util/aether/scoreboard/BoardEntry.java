package gg.arcdev.practice.util.aether.scoreboard;
...
public class BoardEntry
{
    ...
    public BoardEntry send(final int position) {
        ...
        if (this.text.length() > 16) {
            final boolean fix = this.text.toCharArray()[15] == CC.COLOR_CHAR;

            prefix = fix ? this.text.substring(0, 15) : this.text.substring(0, 16);
            suffix = fix ? this.text.substring(15) : (ChatColor.getLastColors(prefix) + this.text.substring(16));
