package gg.arcdev.practice.util.aether;

import gg.arcdev.practice.util.aether.event.BoardCreateEvent;
import gg.arcdev.practice.util.aether.scoreboard.Board;
import gg.arcdev.practice.util.aether.scoreboard.BoardAdapter;
import gg.arcdev.practice.util.aether.scoreboard.BoardEntry;
